...
**[TypeScript with React](/docs/typescript/typescript-with-react)** connects all these pieces. You'll learn the patterns that make TypeScript and React work beautifully together.

[Continue to TypeScript with React ’](/docs/typescript/typescript-with-react)
